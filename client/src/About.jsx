...
const About=()=>{
    ...
    const{
        ...
        //     if(u.gender==='זכר'){setCountSex(...countSex,countSex[0]++)} else if(u.gender==='נקבה'){setCountSex(...countSex,countSex[1]++)};
        //     // d-u.birthDate.getFullYear()>=10 && d-u.birthDate.getFullYear()<=0?countAge[0]++:''
        // })
        return(
            <>
    <BarSeg labels={genderLabels} data={countSex} question={''}/>
