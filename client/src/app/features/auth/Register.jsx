...
<div className="card flex justify-content-center">
    {console.log(visible)}
            ...
            <Dialog
                ...
                content={({ hide }) => (
                    <div className="flex flex-column px-8 py-5 gap-4" style={{ borderRadius: '12px', backgroundImage: 'radial-gradient(circle at left top, var(--primary-400), var(--primary-700))' }}>
                        ...
                        <div className="inline-flex flex-column gap-2">
                            ...
                            <InputText id="name" label="Name" className="bg-white-alpha-20 border-none p-3 text-primary-50"ref={name}></InputText>
                        </div>
                        <div className="inline-flex flex-column gap-2">
                        ...
                        <div className="inline-flex flex-column gap-2" >
                        <label htmlFor="birthDate" className="text-primary-50 font-semibold">
                            birthDate
                            </label>
                        ...
                        <div className="inline-flex flex-column gap-2">
                            ...
                            <InputText id="email" label="Email" keyfilter="email" className="bg-white-alpha-20 border-none p-3 text-primary-50"ref={email}>
             ...
             <label htmlFor="sector" className="text-primary-50 font-semibold">
                            sector 
                            </label> 
            <div className="flex flex-column gap-3">
                {categories.map((category) => {
                    return (
                        ...
                        <div className="flex align-items-center gap-2">
                            <Button label="Sign-In" onClick={(e) => {hide(e); register()}} text className="p-3 w-full text-primary-50 border-1 border-white-alpha-30 hover:bg-white-alpha-10"></Button>
